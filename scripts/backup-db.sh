...
# Vaultwarden
echo "Stopping Vaultwarden for cold backup..."
docker stop vaultwarden
echo "Copying Vaultwarden data to host..."
# This copies everything: the db, the rsa keys, and attachments perfectly intact
